$(document).ready(function() {
	...
	var buildArea = function(){
		Morris.Area({
			element: 'hero-area',
			data: [
			  {period: '2015-05-24', iphone: 10, ipad: 40, itouch: 40},
			  {period: '2015-05-25', iphone: 20, ipad: 50, itouch: 30},
			  {period: '2015-05-26', iphone: 20, ipad: 50, itouch: 24},
			  {period: '2015-05-27', iphone: 60, ipad: 36, itouch: 10},
			  {period: '2015-05-28', iphone: 53, ipad: 12, itouch: 0},
			  {period: '2015-05-29', iphone: 44, ipad: 10, itouch: 10},
			  {period: '2015-05-30', iphone: 50, ipad: 0, itouch: 24}
			],
			xkey: 'period',
