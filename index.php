...
$authPages->addPage(		new Page(						array(	array('seller', 'login'),
																	...
																	array('seller', 'logout')),										'views/seller/login.php',                       'Login',                                        false, true     ));
$authPages->addPage(		new Page(						array(	array('seller', 'register')),									'views/seller/register.php',                    'Register',                                     false, true     ));
$authPages->addPage(		new Page(						array(	array('seller', 'reset'), 
																	array('seller', 'reset', '*')),									'views/seller/reset.php',                       'Reset Password',                               false, true     ));
$dashboard->addPage(		new Page(						array(	array('seller'),
                                                                    array('seller', 'chart')), 										'views/seller/home.php', 						'Dashboard',                'Subtext',          false, true     ));
...
$messages->addPage(			new Page(						array(	array('seller', 'messages', 'compose'),
																	array('seller', 'messages', 'reply', '*')), 					'views/seller/messages-compose.php', 			'Compose Message',			'Subtext'                           ));
...
$products->addPage(			new Page(						array(	array('seller', 'products', 'create'),
																	array('seller', 'products', 'edit', '*')),                      'views/seller/products-create-edit.php', 		'Create Product',		    'Subtext'                           ));
...
$coupons->addPage(          new Page(                       array(  array('seller', 'coupons', 'create'),
                                                                    array('seller', 'coupons', 'edit', '*')),                       'views/seller/coupons-create-edit.php',         'Create Coupon',            'Subtext'                           ));
