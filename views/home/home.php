...
<section class="support">
    ...
    <h2 class="hero-h2">Multiple Currencies Supported</h2>
    <div class="row">
        <div class="feature-list">
            ...
            <div class="col-md-3 feature-item">
                ...
                <h4 class="">Storage</h4>
                <p>List unlimited products with up to 500 MB of storage.</p>
            </div>
            <div class="col-md-3 feature-item">
                <img src="/themes/home/img/customize_3.png" height="75">
                <h4 class="">Flexibility</h4>
                <p>Support many types of online businesses with flexible options.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="checkout">
    <div class="container">
        ...
        <h4 class="checkout-slogan">Keep Your Customers Happy with Instant Digital Product Delivery</h4>
...
<section class="control-w-crypto">
    <h1 class="control-header">Take Control with Cryptocurreny Payments</h1>
    <h4 class="control-slogan">Avoid Unneccessary Hassle and Stop Chargebacks</h4>
    ...
    <section class="register" style="">
        <div class="container register-container">
            ...
            <div class="text-center form-text" style="margin-top:15px;">
                By signing up you agree to  our <a href="#">Terms of Service</a> and our <a href="//www.iubenda.com/privacy-policy/954106" class="no-brand iubenda-nostyle iubenda-embed" title="Privacy Policy">Privacy Policy</a>
            </div>
        </div>
        <div class="clearfix"></div>
    </section>
